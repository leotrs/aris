...
class AnthropicProvider(LLMProvider):
    ...
    async def chat_completion(
        ...
        if not await self.is_available():
            raise ProviderUnavailableError("Anthropic provider is not properly configured", "anthropic")
        ...
        try:
            ...
            if "rate_limit" in error_msg.lower():
                ...
                raise ProviderUnavailableError(f"Authentication error: {error_msg}", "anthropic")
            elif "quota" in error_msg.lower() or "credit" in error_msg.lower():
                raise ProviderUnavailableError(f"Quota exceeded: {error_msg}", "anthropic")
            else:
