...
class TestEmailService:
    ...
    def test_email_service_initialization(self):
        ...
        with patch('aris.services.email.resend') as mock_resend:
            service = EmailService(config)
            assert service.config == config
            mock_resend.api_key = "test_key"

    @pytest.mark.asyncio
    async def test_send_waitlist_confirmation_success(self):
    ...
    @pytest.mark.asyncio
    async def test_send_waitlist_confirmation_failure(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_email_template_content(self):
