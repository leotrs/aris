...
describe("useClosable", () => {
  ...
  describe("initialization", () => {
    ...
    it("should setup keyboard shortcuts when closeOnEsc is true", () => {
      ...
      expect(mockUseKeyboardShortcuts).toHaveBeenCalledWith({ escape: mockOnClose }, true);
    });
  ...
  describe("outside click handling", () => {
    ...
    it("should not setup outside click when disabled", async () => {
      ...
      expect(document.addEventListener).not.toHaveBeenCalledWith("click", expect.any(Function));
    });
  ...
  describe("close button handling", () => {
    it("should setup close button listener when enabled", () => {
      ...
      expect(mockCloseButton.addEventListener).toHaveBeenCalledWith("click", mockOnClose);
    });
    ...
    it("should remove close button listener when deactivated", () => {
      ...
      expect(mockCloseButton.removeEventListener).toHaveBeenCalledWith("click", mockOnClose);
    });
    ...
    it("should use custom close button selector", () => {
      ...
      expect(customButton.addEventListener).toHaveBeenCalledWith("click", mockOnClose);
    });
