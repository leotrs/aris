...
describe("useListKeyboardNavigation", () => {
  ...
  it("warns on invalid list length in nextItem", () => {
    const listLengthRef = ref(0);
    const rootElementRef = ref(null);
    const { nextItem, activeIndex } = useListKeyboardNavigation(
      listLengthRef,
      rootElementRef,
      false,
      false
  ...
  it("cycles prevItem correctly", () => {
    const listLengthRef = ref(3);
    const rootElementRef = ref(null);
    const { prevItem, activeIndex } = useListKeyboardNavigation(
      listLengthRef,
      rootElementRef,
      false,
      false
  ...
  it("clears selection correctly", () => {
    const listLengthRef = ref(3);
    const rootElementRef = ref(null);
    const { nextItem, clearSelection, activeIndex } = useListKeyboardNavigation(
      listLengthRef,
      rootElementRef,
      false,
      false
  ...
  it("does not handle key events until activated when autoActivate is false", () => {
    const listLengthRef = ref(3);
    const rootElementRef = ref(document.createElement("div"));
    const { activeIndex, activate } = useListKeyboardNavigation(
      listLengthRef,
      rootElementRef,
      false,
      false
