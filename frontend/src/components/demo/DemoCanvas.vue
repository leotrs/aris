<script setup>
  ...
  import ReaderTopbar from "@/views/workspace/ReaderTopbar.vue";
  import Dock from "@/views/workspace/Dock.vue";
  import Editor from "@/views/workspace/Editor.vue";
  import DockableMinimap from "@/views/workspace/DockableMinimap.vue";
  import DockableSearch from "@/views/workspace/DockableSearch.vue";
  import DockableAnnotations from "@/views/workspace/DockableAnnotations.vue";
  import DemoManuscriptWrapper from "./DemoManuscriptWrapper.vue";
  ...
  watch(
    ...
    async () => {
      ...
      // For demo mode, we'll just assume the title is visible
          ...
          <div ref="middle-column-ref" class="middle-column">
            ...
            <Dock class="dock middle main">
              <DemoManuscriptWrapper
                ...
                :show-footer="true"
                @mounted-at="(el) => (file.isMountedAt = el)"
              />
            </Dock>
          </div>
