<template>
  <PageLayout>
    ...
    <p>
      Welcome to RSM Studio. We take your privacy seriously. This Privacy Policy explains how we
      collect, use, and protect your personal data when you use our collaborative authoring
      platform.
    </p>
    <p>
      This policy complies with the General Data Protection Regulation (GDPR) and applies to all
      users of RSM Studio.
    </p>
    ...
    <ul>
      <li>
        <strong>Legitimate interests</strong> (Article 6(1)(f) GDPR): To provide and maintain our
        collaborative authoring service
      </li>
      <li>
        <strong>Contract performance</strong> (Article 6(1)(b) GDPR): To fulfill our service
        agreement with you
      </li>
      <li>
        <strong>Legal obligations</strong> (Article 6(1)(c) GDPR): To comply with applicable laws
      </li>
    </ul>
    ...
    <ul>
      <li>
        <strong>Invited collaborators</strong>: Documents and associated data are shared with users
        you explicitly invite
      </li>
      <li>
        <strong>Service providers</strong>: Hosting and infrastructure services that help run our
    ...
    <ul>
      ...
      <li>
        <strong>Documents</strong>: Retained while your account is active or until you delete them
      </li>
      <li>
        <strong>Collaboration history</strong>: Retained with documents for version control and
        attribution
      </li>
    ...
    <p>
      To exercise these rights, contact us at <a href="mailto:leo@leotrs.com">leo@leotrs.com</a>.
    </p>
    ...
    <p>
      These cookies are necessary for the platform to function and cannot be disabled. We do not use
    ...
    <p>
      RSM Studio is not intended for users under 16 years of age. We do not knowingly collect data
      from children.
    </p>
