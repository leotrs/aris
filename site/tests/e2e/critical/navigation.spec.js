...
test.describe('Navigation Flow E2E', () => {
  test('should navigate between all main pages', async ({ page }) => {
    ...
    // Navigate to signup page via hero CTA
    await page.click('text=Try the Demo');
    // Note: This might need to be adjusted based on actual button behavior
    // If "Try the Demo" goes to demo, use signup link instead
    
    // Alternative: Navigate via signup link
    await page.goto('/');
    await page.click('text=sign up for the beta waitlist');
  ...
  test('should handle navbar navigation links', async ({ page }) => {
    ...
    // Test navbar links (these may be external or placeholder)
  ...
  test('should maintain scroll position appropriately', async ({ page }) => {
    ...
    // Depending on browser behavior, scroll position might be restored
